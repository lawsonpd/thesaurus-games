...
print(f"API Key loaded: {'*' * len(WORDS_API_KEY) if WORDS_API_KEY else 'None'}")
...
def process_input():
    ...
    if not input_text.isalpha():
        return Response(
            render_template_string("""
                <div class="mt-3">
                    <p class="has-text-danger mb-2">Please enter only alphabetic characters</p>
                    <div class="box">
    ...
    if input_text == target_word:
        ...
        return Response(
            ...
            <div class="display-section">
                ...
                <div class="box mt-4">
                    <h3 class="subtitle is-6 mb-2">All synonyms for this {{ target_word }}:</h3>
                    <div class="tags are-medium">
                ...
                <div class="box mt-4">
                    ...
                    <div class="tags are-medium">
                        {% for entry in correct_words[:-1] %}
                            <span class="tag">Round {{ entry.round }}: {{ entry.word }}</span>
                        {% endfor %}
                    </div>
                </div>
            {% endif %}
    ...
    return Response(
        render_template_string("""
            <div class="mt-3">
                <p class="has-text-danger mb-2">Try again!</p>
                <div class="box">
                    <h3 class="subtitle is-6 mb-2">Your guesses:</h3>
                    <div class="tags are-medium">
                        {% for guess in guesses %}
        ...
        return Response(
            render_template_string("""
                ...
                <div class="box mt-4">
                    ...
                    <p>You correctly guessed {{ correct_words|length }} words{% if correct_words %}: {% endif %}</p>
                    <div class="tags are-medium">
